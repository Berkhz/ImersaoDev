...
let cards = [
  ...
  },
  {
    ...
    nome: "Obi-Wan Kenobi",
    imagem:
      "https://img.olhardigital.com.br/wp-content/uploads/2021/03/obi-wan-kenobi-1024x635.jpg",
    atributos: {
      ataque: 10,
      defesa: 20,
      magia: 10
  ...
  },
  {
    ...
    nome: "Darth Maul",
    imagem:
      "https://www.greenscene.co.id/wp-content/uploads/2020/07/Maul-696x497.jpg",
    atributos: {
      ataque: 18,
      defesa: 10,
      magia: 10
  ...
  },
  {
    ...
    nome: "Mestre Yoda",
    imagem:
      "https://i.pinimg.com/originals/8a/7d/1f/8a7d1f40a77f99f287c3f2f1eff0d392.jpg",
    atributos: {
      ataque: 20,
      defesa: 10,
      magia: 25
...
function exibirCartaJogador() {
  ...
  for (let atributo in cartaJogador.atributos) {
    if (
      atributosArr[atributosArr.length - 1] <= cartaJogador.atributos[atributo]
    ) {
